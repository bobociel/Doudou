...
-(void)initView
{
    ...
    self.settingArray=@[@"完善我们",@"设置密码",@"清理缓存",@"关于婚礼时光",@"联系客服",@"去评价"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row)
	{
		...
		case WTSetTypeSetPSW:
		{
			...
			{
				[self.navigationController pushViewController:[WTChangePasswordViewController new] animated:YES];
			}
			else
			{
				[self.navigationController pushViewController:[WTBindingViewController new] animated:YES];
			}
		} break;
