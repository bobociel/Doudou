...
<
    ...
    WTTopViewDelegate,BottomServiceViewDelegate,BottomSupplierViewDelegate
>
...
- (void)viewDidLoad {
	...
	self.bottomService.mainDelegate = self;
...
- (void)loadData
{
	...
	[GetService getWorkDetailWithPostId:_works_id Block:^(NSDictionary *result, NSError *error) {
...
- (void)initBottomView
{
	...
	if(_isAdmin){
		_bottomService.supplier_avatar = _postDetail.supplier_info.supplier_avatar;
		_bottomService.tel_num = kServerPhone;
...
- (UIView *)getHeaderView
{
	...
	UILabel *companyLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, titleLabel.bottom+10, screenWidth - 20*2, kCompanyHeight)];
