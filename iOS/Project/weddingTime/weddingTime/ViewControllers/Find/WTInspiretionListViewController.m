...
@interface WTInspiretionListViewController ()<InspirationViewCellDelegate,PhotoModelDelegate>
{
    ...
    NSURLSessionDataTask *lastRequest;
}
...
-(void)initView
{
    ...
    self.dataCollectionView.margin = 10;
...
- (void)changeimage:(BOOL)isfav :(UIButton*)btn{
    [btn setImage:isfav?[UIImage imageNamed:@"icon_like"]:[UIImage imageNamed:@"icon_unlike"] forState:UIControlStateNormal];
}
