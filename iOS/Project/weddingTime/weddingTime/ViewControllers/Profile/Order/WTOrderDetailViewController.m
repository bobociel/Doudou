...
- (void)convButtonAction
{
    [self conversationSelectType:WTConversationTypeSupplier
					 supplier_id:_result[@"supplier_user_id"]
				   sendToAskData:nil
							name:_result[@"supplier_company"]
						   phone:[LWUtil getString:_result[@"supplier_phone"] andDefaultStr:@""]
						  avatar:order.supplier_logo];
}
