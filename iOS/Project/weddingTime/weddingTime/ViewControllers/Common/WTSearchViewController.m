...
- (void)viewDidAppear:(BOOL)animated
{
	...
	if(self.searchKey.length > 0 && ![searchTextField.text isEqualToString:_searchKey]){
		searchTextField.text = [LWUtil getString:_searchKey andDefaultStr:@""];
		[self begainSearch];
	}
}
