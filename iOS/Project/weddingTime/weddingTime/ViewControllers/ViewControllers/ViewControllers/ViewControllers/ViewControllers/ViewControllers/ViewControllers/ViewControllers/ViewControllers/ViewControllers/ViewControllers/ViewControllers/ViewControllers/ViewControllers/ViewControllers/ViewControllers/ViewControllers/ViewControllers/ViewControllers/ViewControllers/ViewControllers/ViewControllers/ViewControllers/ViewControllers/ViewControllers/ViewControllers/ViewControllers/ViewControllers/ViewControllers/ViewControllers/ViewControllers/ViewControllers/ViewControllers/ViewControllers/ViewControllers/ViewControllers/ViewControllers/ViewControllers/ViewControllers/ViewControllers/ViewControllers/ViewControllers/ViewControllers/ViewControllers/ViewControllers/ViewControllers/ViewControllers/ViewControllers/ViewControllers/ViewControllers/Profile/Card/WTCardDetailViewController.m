...
- (void)viewDidLoad
{
	...
	self.dataTableView.tableHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, screenWidth, 0.01)];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
	...
	if(section == WTCardCellTypeIntro){
		...
		[self.headImageView setImageWithURL:[NSURL URLWithString:[_card.main_pic stringByAppendingString:kSmall600]]
								placeholder:nil];
