...
@protocol KYCuteViewDelegate <NSObject>

@optional
-(void)clear;
@end

@interface KYCuteView : UIView<UIGestureRecognizerDelegate>
@property (nonatomic,weak)id<KYCuteViewDelegate>delegate;
//父视图
...
@property (nonatomic,strong)UIButton *frontView;
