...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    dispatch_once(&onece, ^{
        ...
        baseScrollView.contentSize=CGSizeMake(0, contentSizeHeight + 10);
        ...
        for (int i=0; i<categoryBtns.count; i++) {
            ...
            //            transformTopAnimation.springBounciness       = 1;
            //            transformTopAnimation.springSpeed            = 3;
...
-(void)plan_selected
{
    ...
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignPlan];
    sh.listType = supplier_type;
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignWeddingPhotos];
    sh.listType = supplier_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignWeddingveil];
    sh.listType = supplier_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignHost];
    sh.listType = supplier_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignWeddingAddress];
    sh.listType = supplier_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignMakeUp];
    sh.listType = supplier_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignVideo];
    sh.listType = supplier_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
...
{
    WTSHViewController *sh = [[WTSHViewController alloc] init];
    sh.supplier_type = [SliderListVCManager getSupplierTypeWithSign:WiddingListVCSignHotel];
    sh.listType = hotel_type;
    [self.navigationController pushViewController:sh animated:YES];
    MSLog();
}
