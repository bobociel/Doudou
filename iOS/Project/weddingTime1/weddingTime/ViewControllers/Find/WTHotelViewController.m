...
- (void)initView
{
	[self setDataTableViewAsDefault:CGRectMake(0, 0, screenWidth, screenHeight - kTabBarHeight)];
...
- (void)initBottomView
{
	_bottom.price = _hotelDetail.hotel_price_start;
...
- (UIView *)getHeaderView
{
	...
	priceNum.text = @(_hotelDetail.hotel_price_start).stringValue;
