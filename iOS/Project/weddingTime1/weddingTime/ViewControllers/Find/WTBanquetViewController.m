...
- (UIView *)getHeader
{
    ...
    //todo
    [topImage sd_setImageWithURL:[NSURL URLWithString:_ballroom.ballroom_avatar] placeholderImage:[UIImage imageNamed:@""]];
    topImage.frame = CGRectMake(0, 0, screenWidth, 360 * Height_ato);
    UIImageView *avatarImage = [UIImageView new];
    [view addSubview:avatarImage];
    //todo
    [avatarImage sd_setImageWithURL:[NSURL URLWithString:_ballroom.hotel_avatar] placeholderImage:[UIImage imageNamed:@""]];
