...
#import "GetService.h"
#define kPageSize 12
#define kAddHeight 65.0
@interface WTCardListViewController () <PSCollectionViewDataSource,PSCollectionViewDelegate>
...
- (CGFloat)heightForViewAtIndex:(NSInteger)index
{
	...
	return screenWidth / 2.0 / card.w * card.h + kAddHeight;
}
