...
//
//    self.prompLabel = [[UILabel alloc] initWithFrame:CGRectMake(45 * Width_ato, 12 * Height_ato, 72 * Width_ato, 18 * Height_ato)];
//    [self addSubview:_prompLabel];
//    _prompLabel.textColor = rgba(153, 153, 153, 1);
//    _prompLabel.font = [WeddingTimeAppInfoManager fontWithSize:14];
}
...
- (void)setImage:(UIImage *)image text:(NSString *)text
{
    ...
    [self setTitleColor:rgba(153, 153, 153, 1) forState:UIControlStateNormal];
