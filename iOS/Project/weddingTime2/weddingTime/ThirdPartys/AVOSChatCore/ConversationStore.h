...
//从本地获取某个对话的更多消息
- (void)queryMoreMessages:(NSString *)conversation from:(NSString*)msgId timestamp:(int64_t)ts limit:(int)limit callback:(ArrayResultBlock)callback;
...
- (double)conversationUnreadCountAll;//除去我和伴侣的会话的其他会话的所有未读
@end
