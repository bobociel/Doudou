...
- (void)setHotelComment:(WTHotelComment *)hotelComment
{
	_hotelComment = hotelComment;
	[_avatarImage sd_setImageWithURL:[NSURL URLWithString:_hotelComment.comment_author_avatar] placeholderImage:[UIImage imageNamed:@"defaultPic"]];
	_titleLabel.text = _hotelComment.comment_author_name;
	_detailLabel.text = _hotelComment.comment_content;
}
