...
- (void)setAsDefault {
    [self setAsCustomWithSize:defaultSize
                      andType:fromType_FromTop
                  ansShowType:showType_pop
                  andDuraTime:defaultDuraTime
              andDimViewColor:[UIColor blackColor]
                   andDimApha:defaultDuraTime
          andcanFromViewTouch:NO
     ];
}
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (self.fromType) {
        case fromType_FromTop: {
            ...
            toViewCenter  = CGPointMake(transitionContext.containerView.center.x,
            ...
            kPOPLayerType = kPOPLayerPositionY;
            toViewCenter  = CGPointMake(transitionContext.containerView.center.x,
                                     2*transitionContext.containerView.center.y
                                     );
            break;
            ...
            kPOPLayerType = kPOPLayerPositionX;
            toViewCenter  = CGPointMake(2*transitionContext.containerView.center.x,
                                     transitionContext.containerView.center.y
                                     );
            break;
        }
