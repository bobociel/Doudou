...
#import "NetworkManager.h"
#define kPageSize 10
@interface WTLikeChildViewController ()<UITableViewDataSource, UITableViewDelegate, WTSHTableViewCellDelegate,WTWeddingShopCellDelegate>
...
{
    if (_array.count > 0 ) {
		return 300 * Height_ato + (_type == LikeTypePost ? 125 : 98);
    } else {
