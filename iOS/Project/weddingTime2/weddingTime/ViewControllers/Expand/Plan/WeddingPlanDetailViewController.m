...
{
	[self tapBackGround];
	close_time == 0 ? [self showAlertViewWithText:@"请先设置完成时间"] : [pickerView show];
}
...
- (void)initView
{
	...
	pickerView = [CommPickView instanceWithStyle:PickViewStylePicker andTag:0 andArray:@[@"当天",@"提前一天",@"提前一周"]];
