...
{
	[self.navigationController pushViewController:[WTSearchViewController instanceSearchVCWithType:SearchTypeInspiretion] animated:YES];
}
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	...
	[imageView setImageUsingProgressViewRingWithURL:[NSURL URLWithString:[[LWUtil getString:data[indexPath.item][@"link"] andDefaultStr:@""] stringByAppendingString:kSmall600]]
	...
	CALayer *dimingLayer = [LWUtil gradientLayerWithFrame:CGRectMake(0, cell.height - 36, cell.width, 36)];
	[cell.contentView.layer addSublayer:dimingLayer];
	
	UIView *bottonView = [[UIView alloc] initWithFrame:CGRectMake(0, cell.height - 36, cell.width, 36)];
	bottonView.backgroundColor = [UIColor clearColor];
	[cell.contentView addSubview:bottonView];

    UILabel *tabLable      = [[UILabel alloc] initWithFrame:CGRectMake(10, 10, cell.width, 16)];
