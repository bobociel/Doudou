...
<
	...
	BottomViewDelegate,WTTopViewDelegate
>
{
...
- (void)initBottomView
{
	[_bottom setCompany:_hotelDetail.hotel_name andPrice:_hotelDetail.hotel_price_start];
	_bottom.supplier_avatar = _hotelDetail.hotel_avatar;
	_bottom.tel_num = kServerPhone ;
	
	_topView.hotel_id = self.hotel_id;
	_topView.is_like = _hotelDetail.is_like;
	_topView.name = _hotelDetail.hotel_name;
	_topView.supplier_avatar = _hotelDetail.hotel_avatar;
}
...
{
	_hotelDetail.is_like = likeButton.selected;
...
- (void)bottomViewCheckSelectedWithDateString:(NSString *)str
{
	[self conversationSelectType:WTConversationTypeHotelOrCustomer
					 supplier_id:_hotel_id
				   sendToAskData:str
...
- (UIView *)getHeaderView
{
    ...
    [blurImage sd_setImageWithURL:[NSURL URLWithString:[_hotelDetail.hotel_avatar stringByAppendingString:kSmall600]]
    ...
    [avatarImage.centerImage sd_setImageWithURL:[NSURL URLWithString:[_hotelDetail.hotel_avatar stringByAppendingString:kSmall600]]
