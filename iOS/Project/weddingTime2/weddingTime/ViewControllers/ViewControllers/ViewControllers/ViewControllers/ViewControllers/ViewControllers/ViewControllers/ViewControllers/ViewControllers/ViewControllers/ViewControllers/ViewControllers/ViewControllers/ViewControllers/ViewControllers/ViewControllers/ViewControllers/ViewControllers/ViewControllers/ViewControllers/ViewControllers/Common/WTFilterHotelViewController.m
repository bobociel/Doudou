...
- (void)initView
{
	...
	index = _filters.index ? _filters.index : [NSIndexPath indexPathForRow:0 inSection:0]  ;
...
- (void)loadData
{
    ...
    NSDictionary *dic1 = @{@"id" : @"score",@"name" : @"综合排序"};
    NSDictionary *dic2 = @{@"id" : @"like_num",@"name" : @"按喜欢"};
    NSDictionary *dic3 = @{@"id" : @"comment_num",@"name" : @"按评价"};
