...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:heightForRowAtIndexPath:)])
        height = [_SKSTableViewDelegate tableView:tableView heightForRowAtIndexPath:indexPath];
...
- (CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:heightForFooterInSection:)])
        height = [_SKSTableViewDelegate tableView:tableView heightForFooterInSection:section];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:viewForHeaderInSection:)])
        header = [_SKSTableViewDelegate tableView:tableView viewForHeaderInSection:section];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    if ([_SKSTableViewDelegate respondsToSelector:@selector(tableView:viewForFooterInSection:)])
        footer = [_SKSTableViewDelegate tableView:tableView viewForFooterInSection:section];
...
{
	((SKSTableViewCell*)[self cellForRowAtIndexPath:indexPath]).isExpanded = YES;
...
{
	((SKSTableViewCell*)[self cellForRowAtIndexPath:indexPath]).isExpanded = NO;
