...
@property (nonatomic) IBOutlet id <SWTableViewCellDelegate> delegate;
@property (nonatomic, weak) IBOutlet UITableView *containingTableView;
...
- (void)doInitWithRightBtns:(NSArray*)btns;
