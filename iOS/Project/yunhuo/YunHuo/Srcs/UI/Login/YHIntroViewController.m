...
#import "YHIntroViewController.h"
#import "YHConfig.h"

@interface YHIntroViewController ()

@end

@implementation YHIntroViewController
...
//- (void)viewDidAppear:(BOOL)animated
{
	...
	if ( [YHConfig instance].lanuchedBefore )
	{
		[self introDidFinish];
	}
	else
...
- (void)introDidFinish {
	...
	[YHConfig instance].lanuchedBefore = YES;
