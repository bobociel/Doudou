...
#import "YHRiZhiViewController.h"
#import "YHFriendsListViewController.h"

@implementation YHRiZhiCell

@end

@interface YHRiZhiViewController ()

@end

@implementation YHRiZhiViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	YHRiZhiCell *cell = [tableView dequeueReusableCellWithIdentifier:@"YHRiZhiCell" forIndexPath:indexPath];
	return cell;
}
