...
@interface CommentToolbar () <UITextViewDelegate, DXFaceDelegate>{
...
- (void)setupSubviews {
	...
	// 初始化输入框
	self.inputTextView = [[XHMessageTextView  alloc] initWithFrame:CGRectMake(textViewLeftMargin, kVerticalPadding, width - textViewLeftMargin, kInputTextViewMinHeight)];
	...
	if (!self.faceView) {
		...
		self.faceView.backgroundColor = FaceBGColor;
