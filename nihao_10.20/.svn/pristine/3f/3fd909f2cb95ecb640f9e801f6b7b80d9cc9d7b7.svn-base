...
@protocol BackCommentToolbarDelegate;

@interface BackCommentToolbar : UIView

@property (nonatomic, assign) id<BackCommentToolbarDelegate> delegate;
...
@protocol BackCommentToolbarDelegate <NSObject>
