    ...
    if (0==indexPath.section) {
            ...
            switch (indexPath.row) {
                case 2:
                    cell.logLabel.text = @"September 14th KTV Singing and House";
                      cell.iconImageView.image = [UIImage imageNamed:@"icon_locate"];
                 
                    break;
                case 3:
                    cell.logLabel.text = @"September 14th KTV Singing and House";
                      cell.iconImageView.image = [UIImage imageNamed:@"icon_personal"];
                    break;
        ...
        if (0==indexPath.row||1==indexPath.row||4==indexPath.row) {
            ...
            switch (indexPath.row) {
                ...
                case 1:
                    cell.logLabel.text = @"September 14th KTV Singing and House";
                    cell.iconImageView.image = [UIImage imageNamed:@"time_icon"];
                   break;
                case 4:
                    cell.logLabel.text = @"September 14th KTV Singing and House";
                      cell.iconImageView.image = [UIImage imageNamed:@"icon_count"];
                    break;
