...
- (void)setupSubviewsForType:(ChatMoreType)type
{
    ...
    [_photoButton setImage:[UIImage imageNamed:@"chatBar_colorMore_photo_nihao"] forState:UIControlStateNormal];
    [_photoButton setImage:[UIImage imageNamed:@"chatBar_colorMore_photoSelected_nihao"] forState:UIControlStateHighlighted];
...
//    [_takePicButton setFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    ...
    [_takePicButton setImage:[UIImage imageNamed:@"chatBar_colorMore_camera_nihao"] forState:UIControlStateNormal];
    [_takePicButton setImage:[UIImage imageNamed:@"chatBar_colorMore_cameraSelected_nihao"] forState:UIControlStateHighlighted];
