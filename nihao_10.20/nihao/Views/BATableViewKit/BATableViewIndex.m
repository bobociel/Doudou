...
#define BARGB(r,g,b,a)  [UIColor colorWithRed:(double)r/255.0f green:(double)g/255.0f blue:(double)b/255.0f alpha:a]
...
- (CATextLayer*)textLayerWithSize:(CGFloat)size string:(NSString*)string andFrame:(CGRect)frame{
    ...
    [tl setForegroundColor:BARGB(168, 168, 168, 1).CGColor];
    [tl setString:string];
    return tl;
}
